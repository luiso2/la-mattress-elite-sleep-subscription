// Direct test of welcome email template
...
// LA Mattress Welcome Email Template
async function sendWelcomeEmail() {
    ...
    <html>
      <head>
        <style>
          ...
          .coupon-section { background: #fff3e0; padding: 20px; border-radius: 8px; margin: 20px 0; border: 2px dashed #ffd700; }
        ...
        <div class="container">
          ...
          <div class="content">
            ...
            <div class="coupon-section">
              <h3 style="color: #1e40af; margin-top: 0;">🎁 Your First Month Bonus!</h3>
              <p style="font-size: 16px; margin: 10px 0;">A <strong>$15 discount coupon</strong> has been automatically created for you and will be sent shortly.</p>
              <p style="font-size: 14px; color: #666; margin: 10px 0;">This coupon is valid for 30 days and can be used on any purchase.</p>
            </div>
  ...
  try {
    console.log('📧 Sending LA Mattress welcome email to:', email);
    console.log('👤 Customer Name:', customerName);
    console.log('🎟️ This email simulates what would be sent when a $15 coupon is created\n');

    const info = await transporter.sendMail({
      from: '"LA Mattress Elite Sleep+" <lamattress.brand@gmail.com>',
      to: email,
      subject: '🎉 Welcome to LA MATTRESS Elite Sleep+ - Your $15 Coupon is Ready!',
      html,
      text: `
        ...
        Congratulations! Your Elite Sleep+ membership has been successfully activated.

        YOUR FIRST MONTH BONUS:
        A $15 discount coupon has been automatically created for you!
    ...
    console.log('   - Welcome message with all benefits');
    console.log('   - $15 coupon notification');
    console.log('   - Portal access instructions');
...
console.log('LA MATTRESS - Elite Sleep+ Welcome Email Test');
console.log('='.repeat(60));
console.log('\nThis simulates the email sent when:');
console.log('1. A customer completes their first payment');
console.log('2. A $15 coupon is generated');
console.log('3. The webhook is triggered by Stripe');
console.log('='.repeat(60) + '\n');
